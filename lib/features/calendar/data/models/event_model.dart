...
class RecurrenceRule extends Equatable {
  ...
  String get displayLabel {
    ...
    if (type == RecurrenceType.weekly &&
      ...
      if (daysOfWeek!.length == 7)
        ...
        weekdayStr =
            ' on ${daysOfWeek!.map((d) => _getWeekdayShort(d)).join(', ')}';
    }
    String monthDayStr = '';
  ...
  factory RecurrenceRule.fromJson(Map<String, dynamic> json) => RecurrenceRule(
    ...
    monthsOfYear: (json['monthsOfYear'] as List?)
        ?.map((e) => e as int)
        .toList(),
...
class EventModel extends Equatable {
  ...
  factory EventModel.fromJson(Map<String, dynamic> json) => EventModel(
    ...
    availability: json['availability'] != null
        ? EventAvailability.values[json['availability'] as int]
        : EventAvailability.busy,
    visibility: json['visibility'] != null
        ? EventVisibility.values[json['visibility'] as int]
        : EventVisibility.initial,
  );
