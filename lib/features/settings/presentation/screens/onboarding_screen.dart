...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void _nextPage() {
    if (_currentPage < 3) {
      ...
      context.read<SettingsBloc>().add(UpdateOnboardingCompleted(true));
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPermissionItem(
            ...
            description:
                'To sync events from Google Calendar, iCloud, and others. Ensure your account is added in device Settings.',
          ...
          _buildPermissionItem(
            ...
            title: 'Notifications',
            description:
                'To ensure you never miss an important event or meeting.',
          ...
          _buildPermissionItem(
            ...
            title: 'Contacts',
            description:
                'To automatically find and sync birthdays of your friends and family.',
            isGranted: _contactsGranted,
            onPressed: () async {
              if (await FlutterContacts.requestPermission()) {
                final birthdays = await BirthdayService().fetchBirthdays();
                context.read<CalendarBloc>().add(SyncBirthdays(birthdays));
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFeatureRow(
            Icons.repeat,
            'Recurring Events',
            'Flexible rules for repeating tasks.',
          ),
        ],
      ),
    );
